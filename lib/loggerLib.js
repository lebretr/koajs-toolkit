...
exports.Logger = class Logger {
    ...
    #log_with_compatibility=function(a,b,...c){
        ...
        if(a==='debug'){
            ...
            if (typeof b === 'object'){
                this.genuine_log(a,  { message: b },...c);
            }else{
                this.genuine_log(a,b,...c);
            }
        } else{
            this.error(a,b,...c);
        }
    ...
    error=function(a,...b){
        if(a && a.message){
            this.genuine_log('error',a.message,...b);
        }else{
            this.genuine_log('error',{ message: a },...b);
        }
    };
    
    debug=function(a,...b){
        if(a && a.stack){
            this.genuine_log('debug',a.stack,...b);
        }else{
            this.genuine_log('debug',{ message: a },...b);
        }
    };
...
exports.LoggerAsync = async function LoggerAsync (conf,name) {

    return await new exports.Logger (conf,name);
